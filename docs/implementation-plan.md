...
- **Status:** built + fully localhost-verified (tsc both ends, eslint, `next build`, migration applied, live API drive of carton/box returns + guards + CSV + return-status). **NOT committed, NOT deployed** as of 2026-07-22 — awaiting client go-ahead → TEST → UAT → LIVE.
