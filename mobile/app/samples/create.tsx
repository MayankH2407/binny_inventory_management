...
import type { ChildBoxWithProduct, SampleRecord, Customer } from '../../types';
...
function SampleCreateScreen() {
  ...
  const handleSubmit = () => {
    ...
    if (scannedBarcodes.length === 0) {
      Alert.alert('Validation', 'Scan at least one child box before creating the sample.');
      return;
    }
  ...
  return (
    ...
    >
      ...
      <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
        ...
        {/* ── Submit ───────────────────────────────────────────────────────── */}
        <Button
          title={`Create Sample (${scannedBarcodes.length} boxes)`}
