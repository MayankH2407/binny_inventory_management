...
**NOT committed, NOT deployed.** Broad blast radius (dispatch, inventory, reports, 6 pages) + 1 migration → run FULL localhost→TEST→client-UAT→LIVE (no fast-track). Spec files in scratchpad: `carton-membership-spec.md` (backend), `carton-membership-frontend-spec.md`.
